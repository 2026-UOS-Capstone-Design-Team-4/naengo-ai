...
GET_ADMIN_USER_RECIPES_SUMMARY = "[관리자] 제출 레시피 목록 조회"
GET_ADMIN_USER_RECIPES_DESCRIPTION = r"""
관리자가 사용자가 제출한 레시피 목록을 조회합니다.

목록은 최신 제출순(`user_recipe_id` 내림차순)으로 반환합니다.
...
GET_ADMIN_USER_RECIPE_SUMMARY = "[관리자] 제출 레시피 상세 조회"
...
PATCH_ADMIN_USER_RECIPE_DESCRIPTION = r"""
...
DELETE_ADMIN_USER_RECIPE_SUMMARY = "[관리자] 비활성 제출 레시피 물리 삭제"
DELETE_ADMIN_USER_RECIPE_DESCRIPTION = r"""
