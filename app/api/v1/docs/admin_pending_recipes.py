...
# ── PATCH /admin/pending-recipes/{pending_recipe_id} ──────────────────────────

PATCH_ADMIN_PENDING_RECIPE_SUMMARY = "[어드민] 제출 레시피 상태 수정"
PATCH_ADMIN_PENDING_RECIPE_DESCRIPTION = r"""
제출된 레시피의 내용과 상태를 수정합니다.

- `status`를 변경하면 `reviewed_at`이 현재 시각으로 자동 기록됩니다.
- 전달하지 않은 필드는 변경되지 않습니다.
...
| `admin_note` | string \| null | 어드민 검토 메모 |
"""
