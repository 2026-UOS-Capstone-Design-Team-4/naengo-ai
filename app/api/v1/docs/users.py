...
현재 사용자의 기본 정보(`email`, `nickname`)를 수정합니다.
...
PATCH_ME_RESPONSES = {
    200: {
        ...
        "content": {
            "application/json": {"example": USER_EXAMPLE}
        },
    },
...
| 필드 | 타입 | 설명 |
|------|------|------|
| `user_input` | string[] | 사용자가 직접 입력한 취향/알레르기 정보 |
"""
...
GET_MY_PROFILE_RESPONSES = {
    200: {
        "description": "사용자 프로필",
        "content": {
            "application/json": {"example": USER_PROFILE_EXAMPLE}
        },
    },
...
- 기존 `user_input` 배열을 요청 바디의 배열로 덮어씁니다.
...
| 필드 | 타입 | 설명 |
|------|------|------|
| `user_input` | string[] | 새로운 취향/알레르기 정보 목록 |
"""
...
PATCH_MY_PROFILE_RESPONSES = {
    ...
    404: {"description": "사용자 또는 프로필을 찾을 수 없습니다."},
}
